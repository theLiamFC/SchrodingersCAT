...
#define SERV_0_HEADER "Pic2PicLeaderFSM.h"
// the name of the Init function
#define SERV_0_INIT InitPic2PicLeaderFSM
// the name of the run function
#define SERV_0_RUN RunPic2PicLeaderFSM
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "ButtonService.h"
// the name of the Init function
#define SERV_2_INIT InitButtonService
// the name of the run function
#define SERV_2_RUN RunButtonService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "IntakeService.h"
// the name of the Init function
#define SERV_3_INIT InitIntakeService
// the name of the run function
#define SERV_3_RUN RunIntakeService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "TopLevelSM.h"
// the name of the Init function
#define SERV_4_INIT InitTopLevelSM
// the name of the run function
#define SERV_4_RUN RunTopLevelSM
// How big should this services Queue be?
...
typedef enum
{
    ...
    // Events for Pic2Pic Comms
    PIC2_COMM,
    PIC2_RECEIVE,
    PIC2_ERROR,

    // Events for HSM and Robot Game
    ES_ENTRY,
    ES_ENTRY_HISTORY,
    ES_EXIT,
    ES_TAPE_FOUND,
    ...
    // Events for MoveSM
    ES_MID_ALIGN, // robot in middle row
    ES_O_ALIGN,   // robot aligned theta
    ES_X_ALIGN,   // robot aligned x direction
    ES_Y_ALIGN,   // robot aligned y direction
    SPI_RX,
    ES_STOP,
    ES_RCW90,
    ES_RCW45,
    ...
    ES_BEGIN_INTAKE,
            ...
            ES_GET_BLOCK3,
            ES_INTAKE_BACKUP,
            ES_MOVE_INTAKE_SERVO,
            ES_REV_INTAKE,
            ES_INTAKE_DONE,
            ES_SHAKE,
            ES_BAKE,
            ES_BACKUP_BEFORE_SHAKE,

    // Used in Beacon Service
    ES_FIND_BEACON,
    ES_BEACON_FOUND,
    ES_STACKR,
    ES_STACKB,
...
#define EVENT_CHECK_LIST Check4Keystroke, CheckButton
...
#define TIMER7_RESP_FUNC PostServoService
#define TIMER8_RESP_FUNC  PostIntakeService
#define TIMER9_RESP_FUNC  PostTopLevelSM
#define TIMER10_RESP_FUNC PostTopLevelSM
#define TIMER11_RESP_FUNC PostTopLevelSM
#define TIMER12_RESP_FUNC PostServoService
#define TIMER13_RESP_FUNC PostPic2PicLeaderFSM
#define TIMER14_RESP_FUNC PostServoService
#define TIMER15_RESP_FUNC PostTopLevelSM
...
#define STARTUP_TIMER 15
#define GAME_TIMER 14
#define PIC2_TIMER 13
#define SERVO_TIMER 12
#define DRIVE_DELAY_TIMER 11
#define ARM_DELAY_TIMER 10
#define CLEANUP_TIMER 9
#define INTAKE_TIMER 8
#define ARM_IDLE_TIMER 7
