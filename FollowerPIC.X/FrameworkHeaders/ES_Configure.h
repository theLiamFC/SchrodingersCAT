...
#define SERV_0_HEADER "Pic2PicFollowerFSM.h"
// the name of the Init function
#define SERV_0_INIT InitPic2PicFollowerFSM
// the name of the run function
#define SERV_0_RUN RunPic2PicFollowerFSM
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "BeaconService.h"
// the name of the Init function
#define SERV_1_INIT InitBeaconService
// the name of the run function
#define SERV_1_RUN RunBeaconService
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4Intersection, Check4Turn, Check4T //, Check4TFront
...
#define TIMER9_RESP_FUNC PostPic2PicFollowerFSM
#define TIMER10_RESP_FUNC PostMotorService
#define TIMER11_RESP_FUNC PostMotorService      // PostRunRobot
#define TIMER12_RESP_FUNC PostMotorService  // PostCommandFSM
#define TIMER13_RESP_FUNC PostBeaconService // PostMotorService
#define TIMER14_RESP_FUNC PostBeaconService
#define TIMER15_RESP_FUNC PostMotorService // PostTopLevelSM
...
#define TURN_TIMER 15
#define BEACON 14
#define TEST_TIMER 13
#define DELAY_TIMER 12
#define MOTOR_TIMER 10
#define DUTY_TIMER 11
#define COMMAND_DELAY_TIMER 9
