...
bool InitTestHarnessService0(uint8_t Priority)
{
    ...
    //Pin RA0 as digital ouput for PWM
    TRISAbits.TRISA0 = 0;
    ANSELAbits.ANSA0 = 0;
...
//        //Configure timer 2
//    T2CONbits.ON = 0;
//    T2CONbits.TCKPS = 3; //prescalar of 1:8 on tmr2
//    T2CONbits.TCS = 0;
//    TMR2 = 0;
//
//    //PR2 = 2499; //1mS period or 1000Hz with 1:8 pre-scale
//    PR2 = 49999; //20mS period
//    
//    //IFS0CLR = _IFS0_T2IF_MASK;
//   
//    
//    //Configure Output Capture for channels 1
//    OC1CONbits.ON = 0;
//    OC1CONbits.SIDL = 0;
//    OC1CONbits.OC32 = 0;
//    OC1CONbits.OCTSEL = 0;
...
//    T2CONbits.ON = 1;
//    
    FullOCSetup(1,5000,2,3);
//    OC1CONbits.ON = 1;
//    T2CONbits.ON = 1;
//    OC1RS = 3000;
//    DB_printf("OC1RS = %d\n", OC1RS);
    
    setServoAngle(1, 2, 90, 180);
